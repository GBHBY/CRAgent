...
public final class CodeReviewPrompts {
     ...
     *
     * @param rules the active coding rules to inject
     * @return the complete system prompt
     */
    public static String getSystemPrompt(String rules) {
        return """
                你是一位专业的代码审查专家（Code Review Expert）。你的职责是对 GitLab Merge Request 的代码变更进行严格、全面的审查。
